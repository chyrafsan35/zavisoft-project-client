    ...
    return (
        <div className='h-95.5 lg:h-187.5 relative'>
            ...
            <div className='absolute bottom-4 left-4 lg:bottom-12 lg:left-12 w-58.75 h-26.5 lg:w-122.5 lg:h-56.5 text-white'>
                ...
                <h2 className='font-semibold text-[14px] lg:text-[24px] m-0 max-w-49.25 max-h-9.5 lg:max-w-122.5 lg:max-h-56.5'>Nike introducing the new air max for everyone's comfort</h2>
                <button className='btn bg-[#4A69E2] py-1 px-2 lg:py-2 lg:px-8 rounded-lg text-[14px] mt-2 lg:mt-6 font-medium font-inter'>SHOP NOW</button>
            </div>
